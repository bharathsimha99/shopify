...
//creating endpoint for signup user
...
app.get('/newcollections', async (rq, res) => {
    let products = await Product.find({})
    let newcolection = products.slice(1).slice(-8);
    console.log("NewCollections fetched")
    res.send(newcolection)
